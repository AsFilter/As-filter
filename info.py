...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002191508167'))
...
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL','-1002191508167'))
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'AS_MOVIE_GROUP') # Support Chat Link Without https:// or @
