...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        if query.from_user.id in ADMINS:
            ...
            await query.answer("Yᴏᴜ ᴅᴏɴ'ᴛ ʜᴀᴠᴇ  ʀɪɢʜᴛs ᴛᴏ ᴅᴏ ᴛʜɪs !", show_alert=True)
    ...
    # don't change anything without contacting me @kingvj01
        ...
        if PREMIUM_AND_REFERAL_MODE == True:
            buttons = [[
                ...
                InlineKeyboardButton('⭕️ ⓊⓅⒹⒶⓉⒺⓈ ⭕️', url=CHNL_LNK)
            ],[
        ...
        buttons = [[
             ...
             InlineKeyboardButton('Bᴏᴛ Sᴛᴀᴛꜱ ❄️', callback_data='stats')             
         ], [             
        ...
        await query.message.edit_text(
            text=script.OWNER_INFO.format(REFERAL_PREMEIUM_TIME, temp.U_NAME, query.from_user.id, REFERAL_COUNT),
            reply_markup=reply_markup,
            parse_mode=enums.ParseMode.HTML
        )
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    InlineKeyboardButton("⟸ Bᴀᴄᴋ", callback_data="help"),
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="telegram.me/AS_Creator1")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
